...
// ignore_for_file: unused_field, must_be_immutable, unused_element, must_call_super, unused_import

import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

import 'list_Horizontal.dart';
import 'Activitys/activity.dart';
import 'pay/pay.dart';
import 'messenger/messenge.dart';
...
class _MyNavigationBarState extends State<MyNavigationBar> {
  ...
  void initState() {
    ...
    MyNavigationBar._scrollController.addListener(() {
      if (MyNavigationBar._scrollController.position.userScrollDirection ==
          ScrollDirection.reverse) {
        // ScrollDirection.reverse: cuộn lên
        setState(() {
          _isVisible = false;
        });
      } else if (MyNavigationBar
...
class _MyGrabState extends State<MyGrab> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      controller: MyNavigationBar._scrollController,
      itemCount: 1,
